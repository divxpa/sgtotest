...
class ObrasReport extends PageBaseSP{
	...
	public function btnExportar_OnClick($sender, $param)
	{
		...
		$hoja1[] = array("Usuario", $this->Session["SPNombreUsuario"]);
		...
		foreach($data as $d){
			...
			if(is_array($certificaciones) and count($certificaciones)){
				$hoja1[] = array("", "Tipo", "Nro.", "Periodo", "% Cert.", "$ Cert.", "Ant. Fin.", "Dto. Ant.", "Ret. Multa", "Fdo. Rep.", "Red. Prec.", "Otros", "Imp. Neto", "Mano Obra", "Imp. Pag.", "Saldo");
