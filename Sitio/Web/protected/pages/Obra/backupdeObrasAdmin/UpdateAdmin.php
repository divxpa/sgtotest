		...
		if($param->CommandName == "AddItem"){
			...
			if($this->IsValid){
				...
				$items = array(
								...
								"Cantidad" =>$this->dgDatos->tcCantidad->txtCantidad->Text,
								//"UnidadMedida"=>$this->dgDatos->tcCantidad->txtCantidad->Text;
								"PrecioUnitario"=>$this->dgDatos->tcPrecioUnitario->txtPrecioUnitario->Text,
								"PrecioTotal"=>$this->dgDatos->tcPrecioTotal->txtPrecioTotal->Text
							);
				$items[] = $items;
				$this->setViewState("Elementos", $items);
				$this->dgDatos->DataSource = $items;
