...
class Home extends PageBaseSP{
	...
	public function Refresh()
	{
		...
		if(!isset($this->Session["ProyectoCurrentPage"])){
			$this->LoadDataPage($data, 0);
		}
		else{
			$this->LoadDataPage($data, $this->Session["ProyectoCurrentPage"]);
		}
	...
	public function LoadDataPage($data, $page){
		$this->Session["ProyectoCurrentPage"] = $page;
	...
	public function btnBuscar_OnClick($sender, $param)
	{
		...
		$this->Session["ProyectoCurrentPage"] = 0;
		$this->Refresh();
	}
