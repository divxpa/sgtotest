...
//            $this->txtFondoReparo->Text=number_format(0,2,",",".");
    ...
    public function CalcularTotales() {
        ...
        foreach ($this->dgDatos->Items as $it) {
            $sumaPrecioTotal+=floatval($it->tcPrecioTotal->txtPrecioTotal->Text);
            $incidenciaTotal+=$it->tcIncidencia->txtIncidencia->Text;
            $sumaImporteAnterior+=floatval($it->tcImporteAnterior->txtImporteAnterior->Text);
            $sumaImporteActual+=floatval($it->tcImporteActual->txtImporteActual->Text);
            $sumaImporteAcum+=floatval($it->tcImporteAcum->txtImporteAcum->Text);
        }
